...
const copy = {
  ...
  uk: {
    ...
    process: {
      ...
      collaboration:
        "Технічна реалізація була за ІІ, як завжди в мене. Дві чесні деталі: логіка витягання зі сторінки пройшла кілька ітерацій, і один модуль довелося обходити, бо він мовчки не завантажувався в деяких конфігураціях. І те, й те — це AI-дебаг у відповідь на симптом, який я бачив у виводі: я флагав проблему, ІІ знаходив і виправляв причину.",
...
function UkBusinessBody({ c }: { c: typeof copy.uk }) {
  return (
    <>
      ...
      <p>
        <strong>Зробити вивід ІІ надійним.</strong> Це була центральна інженерна
        ...
        модель пише; правила вирішують, що випустити назовні. ІІ пише; правила керують.
      </p>
      <p>
      ...
      {/* PullQuote slot — strong candidates: "ІІ пише; правила керують." / "Якщо щось парситься — зберігай це, навіть коли ще не знаєш навіщо." */}
      {/* <PullQuote>TBD</PullQuote> */}
      ...
      <ul>
        ...
        <li>
          ...
          вартість ліда й клієнта), але ще не включаю вартість API ІІ, що впливає на
